...
private def money(cents : Int32, currency : String = "$") : String
  "#{currency}#{plain_money(cents)}"
end

# Format cents as a US-format plain decimal: 10050 → "100.50"
private def plain_money(cents : Int32) : String
...
private def utf8_text(page, font : LibHaru::Font, size : Int32, x : Float32, y : Float32, str : String)
...
private def utf8_text_width(page, font : LibHaru::Font, size : Int32, str : String) : Float32
  LibHaru.page_set_font_and_size(page, font, size.to_f32)
...
private def fill_with_background_color(page, accent : Color)
...
private def render_top_section(page, fonts : Fonts, from : Array(String), top_y : Float32, accent : Color) : Float32
  name = from[0]? || ""
...
private def render_invoice_heading(page, fonts : Fonts, inv_y : Float32, accent : Color)
...
private def render_bill_to(page, fonts : Fonts, client : Array(String), invoice_number : String, invoice_date : String, due_date : String, bill_y : Float32, accent : Color) : Float32
...
private def render_table(page, fonts : Fonts, items : Array(InvoiceItem), currency : String, tbl_top : Float32, accent : Color) : Float32
  # Header background
  fill_with_background_color(page, accent)
...
private def render_totals(page, fonts : Fonts, items : Array(InvoiceItem), tax_rate : Float64?, currency : String, row_y : Float32, accent : Color) : Float32
...
private def render_notes(page, fonts : Fonts, notes : String, total_y : Float32, accent : Color)
